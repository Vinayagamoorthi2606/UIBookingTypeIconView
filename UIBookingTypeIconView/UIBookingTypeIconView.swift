...
{   
 ...
 @IBDesignable class UIBookingTypeIconView : UIView {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        if let bundleURL = podBundle.url(forResource: "UIBookingTypeIconView", withExtension: "bundle") {
            
            if let bundle = Bundle(url: bundleURL) {
                UINib(nibName: "UIBookingTypeIconView", bundle: bundle).instantiate(withOwner: self, options: nil)[0] as! UIView
            }
        }
